...
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET &&
  ...
  passport.use(new GoogleStrategy({
    ...
    try {
      ...
      if (!userEmail) {
        // No email provided, return temporary user for username selection
...
// Discord OAuth Strategy (only configure if credentials are provided)
if (process.env.DISCORD_CLIENT_ID && process.env.DISCORD_CLIENT_SECRET &&
    process.env.DISCORD_CLIENT_ID !== 'your_discord_client_id_here') {
